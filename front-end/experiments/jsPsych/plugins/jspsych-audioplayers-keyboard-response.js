  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add label1
      if(trial.label1 !== null){
        new_html += '<br>'+trial.label1+'<br>';
      }
    //show audio1 if there is one
      if (trial.audio1 !== null) {
        new_html += '<audio controls><source src='+trial.audio1+'></audio>';
      }
    // add label2
      if(trial.label2 !== null){
        new_html += '<br><br>'+trial.label2+'<br>';
      }
    //show audio2 if there is one
      if (trial.audio2 !== null) {
        new_html += '<audio controls><source src='+trial.audio2+'></audio>';
      }
    // draw
