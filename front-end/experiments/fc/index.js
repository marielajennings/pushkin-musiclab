...
var songTest1 = {
  timeline: [
    {
      type: 'audio-keyboard-response',
      prompt: '<p align="center">Please listen to the song excerpt.</p><p align="center">What do you think this song is used for?</p><p align="center"><b>S: '+buttons[0]+'&emsp;F: '+buttons[1]+'&emsp;J: '+buttons[2]+'&emsp;L: '+buttons[3]+'</b></p>',
      choices: [keyData[0].key, keyData[1].key, keyData[2].key, keyData[3].key],
      stimulus: jsPsych.timelineVariable('stimulus'),
      data: jsPsych.timelineVariable('data'),
      on_finish: function(data) {
    ...
    {
      type: 'html-keyboard-response',
      stimulus: function(){return '<p align="center">On a scale from 1-4, how much did you like this song? 1 being "hated it" and 4 being "loved it.""<br><br><b>Hear the song again:<br></b> <audio controls><source src='+songPlay1+'></audio></p><div align="center" style="font-size:24pt"><b>1&emsp;&emsp;2&emsp;&emsp;3&emsp;&emsp;4</div><div align="center">Hate it&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Love it</b></div>'},
      choices: ['1', '2', '3', '4'],
      on_finish: function(data){
     saveDataOnFinish(data);
      }
    },
    {
      type: 'image-keyboard-response',
      stimulus: jsPsych.timelineVariable('image'),
      prompt: jsPsych.timelineVariable('blurb'),
      audio: 'Press any key to continue!',
      response_ends_trial: true,
      on_finish: function(data){
      saveDataOnFinish(data);      }
    }
